"""V7 entry copied from train_source_pool.py; model and optimizer logic unchanged."""
import argparse
import copy
import json
import math
...
import random
from v7_common import DATASET, bootstrap, validate_dataset
bootstrap()
import numpy as np
...
def main():
    ...
    if isinstance(train_loader.sampler, RecordingBalancedSampler):
        print("V7 baseline: each epoch 1800/class + 1080 noise; 5:1; 203 batches; 60 full epochs", flush=True)
